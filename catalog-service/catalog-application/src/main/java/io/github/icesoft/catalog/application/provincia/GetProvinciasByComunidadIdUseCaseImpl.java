...
/**
 * Implementación del caso de uso para obtener las provincias de una comunidad autónoma.
 * Facilita la navegación jerárquica del territorio español desde comunidades
 * hacia sus provincias constituyentes.
 * 
...
public class GetProvinciasByComunidadIdUseCaseImpl implements GetProvinciasByComunidadIdUseCase {
	 ...
	 * 
	 * @param repository Puerto de repositorio para operaciones de persistencia de provincias
	 */
