...
/**
 * Representa los parámetros de paginación para solicitudes de consulta. Define
 * qué página solicitar y cuántos elementos incluir por página.
 * 
 * @param page
 *            Número de página a solicitar (basado en 0)
 * @param size
 *            Cantidad de elementos por página
 * 
 * @throws IllegalArgumentException
 *             si page es negativo o size es menor o igual a 0
 * 
