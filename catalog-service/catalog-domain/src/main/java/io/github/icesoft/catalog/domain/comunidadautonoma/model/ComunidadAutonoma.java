...
/**
 * Entidad de dominio que representa una Comunidad Autónoma española. Incluye
 * códigos oficiales para integración con sistemas gubernamentales.
 * 
 * @param id
 *            Identificador único de la comunidad autónoma
 * @param nombre
 *            Nombre oficial de la comunidad autónoma
 * @param rcp
 *            Código RCP (Registro Central de Personal) de la comunidad
 * @param dir2
 *            Código DIR2 (Directorio Común de unidades orgánicas y oficinas)
 * 
 * @throws NullPointerException
 *             si id o nombre son nulos
