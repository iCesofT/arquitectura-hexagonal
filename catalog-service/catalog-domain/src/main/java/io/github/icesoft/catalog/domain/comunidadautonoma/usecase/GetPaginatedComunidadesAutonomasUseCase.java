...
/**
 * Caso de uso para obtener comunidades autónomas de forma paginada.
 * Permite consultar listas de comunidades autónomas con control de paginación para optimizar el rendimiento.
 * 
...
public interface GetPaginatedComunidadesAutonomasUseCase {
	...
	/**
	 * Obtiene una página de comunidades autónomas según los parámetros de paginación especificados.
	 * 
	 * @param paginacion Parámetros de paginación (página y tamaño)
	 * @return Página conteniendo las comunidades autónomas encontradas y metadatos de paginación
