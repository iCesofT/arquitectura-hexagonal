...
/**
 * Puerto de repositorio para la entidad Localidad. Define las operaciones de
 * persistencia necesarias para los casos de uso de localidades. Soporta
 * búsquedas con filtros de texto para facilitar la localización de poblaciones.
 * 
...
public interface LocalidadRepositoryPort {
	...
	/**
	 * Obtiene todas las localidades de forma paginada con capacidad de filtrado por
	 * texto.
	 * 
	 * @param paginacion
	 *            Parámetros de paginación (página y tamaño)
	 * @param query
	 *            Texto de búsqueda para filtrar localidades por nombre (puede ser
	 *            null)
