...
/**
 * Entidad de dominio que representa un País según los estándares
 * internacionales. Incorpora códigos ISO 3166-1 alfa-2 y alfa-3 para
 ...
 * @param alfa2
 *            Código ISO 3166-1 alfa-2 de dos letras (ej: ES, FR, IT)
 * @param alfa3
 *            Código ISO 3166-1 alfa-3 de tres letras (ej: ESP, FRA, ITA)
 * 
