...
/**
 * Puerto de repositorio para la entidad País. Define las operaciones de
 * persistencia necesarias para los casos de uso de países. Implementa el patrón
 * Repository con inversión de dependencias.
 * 
