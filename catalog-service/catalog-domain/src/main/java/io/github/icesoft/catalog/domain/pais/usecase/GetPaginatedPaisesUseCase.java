...
/**
 * Caso de uso para obtener países de forma paginada.
 * Permite consultar listas de países con control de paginación para optimizar el rendimiento.
 * 
...
public interface GetPaginatedPaisesUseCase {
	...
	/**
	 * Obtiene una página de países según los parámetros de paginación especificados.
	 * 
