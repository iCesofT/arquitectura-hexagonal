...
/**
 * Caso de uso para obtener un país por su identificador.
 * Implementa la lógica de negocio para la consulta individual de países.
 * 
...
public interface GetPaisByIdUseCase {
	 ...
	 * @throws io.github.icesoft.catalog.domain.common.exception.NotFoundException si el país no existe
