...
/**
 * Caso de uso para obtener una provincia por su identificador.
 * Implementa la lógica de negocio para la consulta individual de provincias.
 * 
...
public interface GetProvinciaByIdUseCase {
	 ...
	 * @throws io.github.icesoft.catalog.domain.common.exception.NotFoundException si la provincia no existe
