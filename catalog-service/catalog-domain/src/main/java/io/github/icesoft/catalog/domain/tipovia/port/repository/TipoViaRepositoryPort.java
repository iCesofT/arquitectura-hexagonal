...
/**
 * Puerto de repositorio para la entidad Tipo de Vía.
 * Define las operaciones de persistencia necesarias para los casos de uso de tipos de vía.
 * Administra el catálogo de tipos de vías públicas según la normativa española.
 * 
