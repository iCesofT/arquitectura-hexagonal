...
/**
 * Caso de uso para obtener tipos de vía de forma paginada.
 * Permite consultar listas de tipos de vía con control de paginación para optimizar el rendimiento.
 * 
...
public interface GetPaginatedTiposViaUseCase {
	...
	/**
	 * Obtiene una página de tipos de vía según los parámetros de paginación especificados.
	 * 
	 * @param paginacion Parámetros de paginación (página y tamaño)
	 * @return Página conteniendo los tipos de vía encontrados y metadatos de paginación
