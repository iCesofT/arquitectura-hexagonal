...
/**
 * Caso de uso para obtener un tipo de vía por su identificador. Implementa la
 * lógica de negocio para la consulta individual de tipos de vía.
 * 
